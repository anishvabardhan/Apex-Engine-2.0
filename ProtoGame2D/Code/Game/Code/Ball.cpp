...
void Ball::Update(float deltaseconds)
{
	...
	{
		if(m_Position.m_X < 0.0f || m_Position.m_X + 60.0f > 1024.0f)
	    {
	    	m_Accelaration.m_X *= -1;
	    }
	    
	    if(m_Position.m_Y < 0.0f || m_Position.m_Y > 1024.0f)
	    {
